...
public class DateSelectView extends TextView implements View.OnClickListener {
    ...
    public void onClick(final View v) {
        DateSelectPopupWindow myPopupwindow=new DateSelectPopupWindow(mContext,nowDateText,startDateText,endDateText);
    ...
    public  void setupDateText(String nowDataText,String startDateText,String endDateText){
        Log.i(TAG, "setupDateText: nowDataText:"+nowDataText);
        Log.i(TAG, "setupDateText: startDateText:"+startDateText);
        Log.i(TAG, "setupDateText: endDateText:"+endDateText);
        if (nowDataText==null||nowDataText.equals("")||nowDataText.equals("null"))
        {
            nowDateText=DateTool.getChinaDate();
        }else{
            //先转
            Date date=DateTool.parseStr2Data(nowDataText,DateTool.FORMAT_DATE);
            if (date!=null) {
