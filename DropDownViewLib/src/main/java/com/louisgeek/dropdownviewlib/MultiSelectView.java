...
import com.louisgeek.dropdownviewlib.adapter.MultiSelectViewAdapter;
...
public class MultiSelectView extends RelativeLayout {
    ...
    MultiSelectViewAdapter mMultiSelectViewAdapter;
    ...
    private void init(Context context) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_list_muti_select, this);
    ...
    private void initMultiSelectView() {
        ...
        mMultiSelectViewAdapter=new MultiSelectViewAdapter(mContext,multiSelectMapList);
